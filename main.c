...
int main() {
    GraphMatrix graph = createGraph(14); // Kreiranje grafa sa odredjenim brojem cvorova.

    // Dodavanje grana izmedju odredjenih cvorova.
    addVertex(graph, 0, 3);
    addVertex(graph, 3, 6);
    addVertex(graph, 3, 7);
    addVertex(graph, 3, 1);
    ...
    cleanGraph(graph); // Oslobadjanje grafa iz memorije.
